...
Reconfig(i, newConfig, newVersion) ==
    ...
    /\ __Reconfig(i, newConfig, newVersion)_g3__ \* gt: Cardinality(SymmDiff(config[i], newConfig)) <= 1
    /\ __Reconfig(i, newConfig, newVersion)_g4__ \* gt: i \in newConfig
    /\ __Reconfig(i, newConfig, newVersion)_g5__ \* gt: newConfig # config[i]
    /\ configTerm' = __Reconfig(i, newConfig, newVersion)_configTerm__ \* gt: [configTerm EXCEPT ![i] = currentTerm[i]]
    /\ __Reconfig(i, newConfig, newVersion)_g7__ \* gt: newVersion > configVersion[i]
