...
from .grammar_helpers import mk_eq_rule, mk_in_rule, mk_inf_set_store_idiom, mk_nt, mk_atom_rules, mk_param_nt, mk_select_idiom, mk_store_idiom, mk_tnt
...
def update_gfn(hole_info, return_type, var_types, param_args, default):
	...
	grammar = [
		...
		[*mk_tnt(TAS["Configs"], "Start"),
			mk_store_idiom(TAS["Configs"])],
	]
	atom_except = []
	atom_except = dict([(t, mk_nt(t, "Sub")) for t in atom_except])
	atom_require = []
