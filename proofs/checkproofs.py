#
# Script for checking TLAPS proofs easily from the command line.
#
...
def tlapm_check_proof(tla_file):
    ...
    cmd = f"tlapm {solver_flag} --stretch 1 --threads 4 --toolbox 0 0 -I {search_path} --cleanfp --nofp {tla_file}"
    print("tlapm cmd:", cmd)
...
parser.add_argument('--tla_file', help='TLA+ benchmark file containing proofs to check.', default=None, required=True, type=str)
