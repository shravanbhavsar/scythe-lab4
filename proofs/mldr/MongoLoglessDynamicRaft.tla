...
\* Ported over directly from mldr.tla:
\* https://github.com/egolf-cs/tla-synthesis/blob/3aa5a99182112187129a947aaa0434f007d48263/tool_and_experimentation/run_tool/proofs/mldr.tla#L267-L282
Reconfig(i, newConfig) ==
    ...
    /\ configVersion' = [configVersion EXCEPT ![i] = configVersion[i] + 1] \* gt: [configVersion EXCEPT ![i] = newVersion]
