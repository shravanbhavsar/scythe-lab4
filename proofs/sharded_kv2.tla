...
\* 
\* @Derek: Seems like sharded_kv and sharded_kv2 are the same w.r.t
\* the Reshard, RecvTransferMsg, and Put actions?
\* Am I missing some difference b/w them?
\* 
...
Put(n, k, v) ==
    ...
    /\ event_queue' = (event_queue \ event_queue) \* gt: event_queue \ {<<PUT, k, v, PUT>>}
    /\ table' = [table EXCEPT ![<<n, k>>] = v] \* gt: [table EXCEPT ![<<n,k>>] = v]
